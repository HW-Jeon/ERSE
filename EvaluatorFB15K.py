...
if __name__ == "__main__":
    ...
    #     "./RSE_output/FB15K237/PDF_Categorical_TRUE_Mixed_0.5_0.75/entropy_k_"
    #     # "./RSE_output/FB15K237/AVG_RES_PDF_Categorical_Trained_0.5_0.75/entropy_k_"
    # )
    ...
    cfgs.default_entropy_dir_path = (
        ...
        # f"./RSE_output/{strDataset}/TOT_PDF_Trained_0.5_0.75/entropy_k_"
